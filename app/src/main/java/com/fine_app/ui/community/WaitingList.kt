...
class WaitingList : AppCompatActivity() {
    ...
    private val memberId=123123123123 //todo 멤버 아이디 수정 필요
    ...
    inner class MyAdapter(val list:List<Recruit> /*todo api 데이터 형태 확인 필요*/ ): RecyclerView.Adapter<MyViewHolder>() {
